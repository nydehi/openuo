 ...
 *   All Right Reserved.
 *
 *   $Id: ByteQueue.cs 14 2011-10-31 07:03:12Z fdsprod@gmail.com $:
 *
...
namespace OpenUO.Network
{
	...
	public class ByteQueue
	{
		...
		public int GetPacketLength()
		{
			if ( _size >= 5 )
			{
                return (_buffer[(_head + 1) % _buffer.Length] << 24) | (_buffer[(_head + 2) % _buffer.Length] << 16) | (_buffer[(_head + 3) % _buffer.Length] << 8) | _buffer[(_head + 4) % _buffer.Length];
			}
